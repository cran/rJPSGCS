...
/**
	...
	calculated by <a href="HGS.html"> HGS </a>.

<ul>
	Usage : <b> java SimHGS input.par(ld) input.ped [n] </b> </li>
</ul>
	where 
<ul>
...
public class SimHGS extends AlleleSharing
{
	public static void main(String[] args)
	{
		try
		{
			...
			default:
				System.err.println("Usage: java SimHGS input.par(ld) input.ped [n_sims]");
				System.exit(1);
			}
		...
		{
			System.err.println("Caught in SimHGS:main().");
			e.printStackTrace();
		}
	}
}
