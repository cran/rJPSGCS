...
/**
	...
	distribution of the length of  homozygously shared genomic regions, as
	calculated by <a href="HSGS.html"> SGS </a>.

<ul>
	Usage : <b> java SimHomozygousSGS input.par(ld) input.ped [n] </b> </li>
</ul>
	where 
<ul>
...
<p>
	The input for SimHomozygousSGS should be exactly the same as that for HSGS.
...
public class SimHomozygousSGS extends AlleleSharing
{
	public static void main(String[] args)
	{
		try
		{
                        ...
                        default:
                                System.err.println("Usage: java SimHomozygoudSGS input.par(ld) input.ped [n_sims]");
                                System.exit(1);
                        }
		...
		{
			System.err.println("Caught in SimHomozygousSGS:main().");
			e.printStackTrace();
		}
	}
}
